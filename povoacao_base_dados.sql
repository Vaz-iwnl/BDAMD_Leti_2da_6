/* ===============================================================
   SCRIPT 2: POVOAMENTO DE DADOS (DML) - VERSÃO SEGURA
   Este script LIMPA os dados antigos antes de inserir os novos.
   =============================================================== */
...
-- =================================================================
-- 0. LIMPEZA TOTAL (Ordem correta para evitar erros de Chaves Estrangeiras)
-- =================================================================
...
-- =================================================================
-- 1. DADOS BASE (Armazéns, Zonas, Artigos, Pessoas)
-- =================================================================
...
-- =================================================================
-- BLOCO GERAL: POPULAÇÃO DE MOVIMENTOS
-- Serve para: Exercícios 2.1, 2.4, 2.7 e funcionamento geral.
-- ================================================================= 
-- 9. CICLO AUTOMÁTICO
...
INSERT INTO Nota_Encomenda_Detalhe (num_encomenda, referencia_artigo, quantidade) VALUES
(601, 1, 10), (602, 1, 10), (603, 1, 10);


-- 2.6
INSERT INTO Historico_Preco (id_historico, referencia_artigo, preco_antigo, data_inicio, data_fim) VALUES
(3, 4, 6.00, '2014-01-01', '2015-12-31');
...
--  2.9 
UPDATE Guia_Saida 
SET data_guia = '2018-06-30 09:00:00'
WHERE num_encomenda_origem = 502;
GO